...
(function() {
    ...
    function M(b) {
        return -1 == b ? "和了" : 0 == b ? "听牌" : b + "向听"
    }
    function N(b, a) {
        return a && b[0] != b[1] ? "标准形" + M(b[0]) + " / 一般形" + M(b[1]) : M(b[0])
    }
    function ea(b) {
        function a(a) {
            a &= 127;
            ...
            for (b = 0; 4 > b; ++b)
                if (d.c[b].a) {
                    if (0 == b && 4294967295 == d.c[0].a) {
                        ...
                        3 == b && 4294967295 == d.c[3].a ? (c += "七对形和了 ",
    ...
    function fa() {
        ...
        switch (a.substr(0, 1)) {
        case "q":
            d += '标准形(包含七对国士)的计算结果 / <a href="?p' + a.substr(1) + "=" + g + '">一般形</a><br>';
            break;
        case "p":
            d += '一般形(不包含七对国士)的计算结果 / <a href="?q' + a.substr(1) + "=" + g + '">标准形</a><br>'
        }
